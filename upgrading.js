...
var item_slot = 2; //Inventory slot of item to be upgraded
var scroll_slot = 3; //Inventory slot of 1000g scroll (T1)
var scroll2_slot = 4; //Inventory slot of 40000g scroll (T2)
var max_item_level = 8; //Max level to be upgraded to
var item_to_upgrade = "pants" //Name of item to be upgraded
